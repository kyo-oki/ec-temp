...
export function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We offer a 30-day return policy on all unused items in their original packaging. Contact our customer service team to initiate a return.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Currently, we ship within the country only. International shipping may be available for select items - please contact us for more information.",
    },
    {
      question: "How do I care for my sports equipment?",
      answer:
        "Check out our Blog & Resources section for detailed care guides for different types of equipment.",
    },
    {
